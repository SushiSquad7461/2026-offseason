...
//Nishika Edition of SwerveModule

//kept this from the old code
import com.ctre.phoenix6.BaseStatusSignal;
import com.ctre.phoenix6.StatusSignal;
import com.ctre.phoenix6.hardware.CANcoder;
//new neo swerve imports
...
public class SwerveModule {
    ...
    private final RelativeEncoder angleEncoderRelative;
    ...
    private SparkMaxSimState driveMotorSim;
    private SparkmaxFXSimState angleMotorSim;
    ...
    public SwerveModule(int moduleNumber, SwerveModuleConstants moduleConstants){
        ...
        angleMotor.configure(angleConfig, ResetMode.kResetParameters, PersistMode.kPersistParameters);
        driveMotor.configure(angleConfig, ResetMode.kResetParameters, PersistMode.kPersistParameters);
